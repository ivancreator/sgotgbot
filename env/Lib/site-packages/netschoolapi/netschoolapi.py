...
class NetSchoolAPI:
    ...
    async def login(self, user_name: str, password: str, cid: Union[str, int], sid: Union[str, int], pid: Union[str, int], cn: Union[str, int], sft: Union[str, int], scid: Union[str, int]):
        ...
        self._login_data = (user_name, password, cid, sid, pid, cn, sft, scid)
