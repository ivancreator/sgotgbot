...
class NetSchoolAPI:
    ...
    async def login(self, cid: Union[str, int], sid: Union[str, int], pid: Union[str, int], cn: Union[str, int], sft: Union[str, int], scid: Union[str, int], username: str, password: str):
